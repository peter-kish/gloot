...
func _ready() -> void:
    for i in values.size():
        ...
        line_edit.connect("text_submitted", Callable(self, "_on_line_edit_value_entered").bind(line_edit, i))
        line_edit.connect("focus_exited", Callable(self, "_on_line_edit_focus_exited").bind(line_edit, i))
